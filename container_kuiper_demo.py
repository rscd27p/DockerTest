...
connection_niswitch = rpyc.connect('midoe1', 18861)
niswitch = connection_niswitch.root.niswitch

connection_nidcpower = rpyc.connect('midoe1', 18862)
nidcpower = connection_nidcpower.root.nidcpower

connection_dmm = rpyc.connect('midoe1', 18863)
nidmm = connection_dmm.root.nidmm
